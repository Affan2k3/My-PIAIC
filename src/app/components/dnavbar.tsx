...
const links = [
    { name: 'Study programs', href: '#' },
    { name: 'Internship programs', href: '#' },
    { name: 'Our values', href: '#' },
    { name: 'Meet our leadership', href: '#' },
  ]
  const stats = [
    { name: 'IT Organization', value: '#1' },
    { name: 'Over Pakistan', value: 'All' },
    { name: 'Applicants', value: '100K+' },
    { name: 'Students at a time', value: '20K+' },
  ]
      ...
      <div className="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            <h2 className="text-4xl font-bold tracking-tight text-white sm:text-6xl">Presidential Initiative
                for Artificial Intelligence & Computing (PIAIC)</h2>
